# Riverbend Community Garden — website

The website for Riverbend Community Garden. Plain HTML/CSS/JS with no build step: every file
here is served exactly as it is, by Cloudflare Pages, at https://riverbend-garden.pages.dev/.
